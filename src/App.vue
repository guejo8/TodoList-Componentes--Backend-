...
<template>
    ...
    <main class="app">
      <section class="greeting">
        ...
        <div class="cajaImagen">
          <img class="icono floating" src="../src/assets/img/astronauta.png" />
        </div>
      </section>
      ...
      <sectiom class="todo-list">
        ...
        <div class="list">
          ...
          La clase done solo se agrega si la propiedad done del objeto todo es verdadera, lo que se logra utilizando el operador && en una expresión booleana. -->
            ...
            <!-- botones de accion -->
            <div class="actions">
              <!-- activara la funcion borrar y se le pasara la tarea que vamos a eliminar -->
  ...
  <FooterComp class="footerComponente" />
</template>
